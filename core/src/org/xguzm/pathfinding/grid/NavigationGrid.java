 ...
 *
 * @param <T> only classes extending {@link org.xguzm.pathfinding.grid.GridCell} can be used within this graph
 */
public class NavigationGrid<T extends NavigationGridGraphNode> implements NavigationGridGraph<T> {
	 ...
	 * If this constructor is used, make sure to call {@link org.xguzm.pathfinding.grid.NavigationGrid#setNodes(NavigationGridGraphNode[][])} before trying to make
