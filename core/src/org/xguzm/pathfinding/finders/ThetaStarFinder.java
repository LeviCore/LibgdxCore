 ...
 * It also lets you find a path based on coordinates rather than nodes on {@link org.xguzm.pathfinding.grid.NavigationGridGraph}'s.
 * 
 * @author Xavier Guzman
 *
 * @param <T> any class that inherits from {@link org.xguzm.pathfinding.grid.GridCell}
 */
